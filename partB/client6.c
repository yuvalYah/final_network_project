...
#define SERVER_IP_ADDRESS "fe80::a63e:c596:2ccc:e71a"
...
int main()
{
	...
	// Create socket
	if ((s = socket(PF_INET6, SOCK_DGRAM, IPPROTO_UDP)) == -1) // In Windows -1 is SOCKET_ERROR
	{
	...
	serverAddress.sin6_addr/*r.s_addr*/ = in6addr_any;
